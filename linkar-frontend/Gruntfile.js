  ...
  grunt.initConfig({
    ...
    wiredep: {
      app: {
        ...
        ignorePath: /\.\.\//,
        exclude: ['bower_components/moment/moment.js', 'bower_components/angular-bootstrap-datetimepicker/src/js/datetimepicker.js']
      }
    },
    ...
    //       filter: 'isFile',
    //       // path on the server
    //       dest: '/srv/sistema/mgpValidacaoMembro'
    //     }]
    //   },
    // }
